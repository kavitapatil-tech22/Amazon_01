...
public class Amz_SearchingCategory {
	WebDriver driver;
	...
	// reinventPricePriceToPayMargin priceToPay']/span[1]")
...
//	WebElement ratings;
	...
	public void validate_product() {
		Assert.assertTrue(product_selection.isDisplayed(), "category selection is not happen");
	}
...
//	}
	...
	public Amz_SearchingCategory(WebDriver driver)	
	{
