...
//	
	...
	*/
	...
	public void validate_UserEditedProfile() {
		
		String Actual_Saved=addressSaved.getText();
		
		System.out.println("Updated profile successfully message : " + Actual_Saved + " , profile updated successfully");
		Assert.assertEquals(addressSaved.isDisplayed(), true,"not able to update profile successfully");
	}
