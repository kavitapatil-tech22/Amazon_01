...
public class Amz_WishList extends PageUtility
{
	...
	// @FindBy(linkText="View Cart")
	 ...
	 // adding to the wishlist
	  ...
	  {
		 // WebDriverWait expwait= new WebDriverWait(driver,Duration.ofSeconds(30));// explicit wait until appearance of search bar
		//	WebElement searbar=expwait.until(ExpectedConditions.elementToBeClickable(wishlist_close));
		//	searbar.click();
		  
		//  clickabilityOfElement(wishlist_close);
		  
		  visibilityOfElement(wishlist_close);
